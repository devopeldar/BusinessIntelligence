...
const TareaAdd = () => {
    ...
    const validationSchema = yup.object().shape({
        ...
        vencimientoDias: yup.string().required("Indicar el vencimiento en dias habiles de una tarea"),
    });
    ...
    const [selectedValueTareaTipo, setSelectedValueTareaTipo] = useState(elementsTareaTipo[0]);
    const [selectedValueCliente, setSelectedValueCliente] = useState(elementsCliente[0]);
    const [selectedValueDepto, setSelectedValueDepto] = useState(elementsDepto[0]);
...
<Card  style={{ width: "238%", marginL: "-168px" }}>
                <MDBox
                    variant="gradient"
                    bgColor="info"
                    borderRadius="lg"
                                                ...
                                                <TableBody>
                                                    {data.map((item, index) => (
                                                        <TableRow key={index}>
                                                            ...
                                                            <TableCell>
                                                                <IconButton aria-label="Eliminar" onClick={() => eliminarItem(item.id)}>
                                                                    <Delete color="error" />
                                                                </IconButton>
                                                            </TableCell>
                                                        </TableRow>
